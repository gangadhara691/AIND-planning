...
class PlanningGraph():
    ...
    def add_action_level(self, level):
        ...
        for action in self.all_actions:
            ...
            if a_node.prenodes.issubset(self.s_levels[level]):
                for s_node in self.a_levels[level-1]:
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        """
        return bool(set(node_a1.action.effect_add) & set(node_a2.action.effect_rem) | set(node_a2.action.effect_add) & set(node_a1.action.effect_rem))
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        """
        return bool(set(node_a1.action.effect_add) & set(node_a2.action.precond_neg) | set(node_a1.action.effect_rem) & set(node_a2.action.precond_pos) | set(node_a2.action.effect_add) & set(node_a1.action.precond_neg) | set(node_a2.action.effect_rem) & set(node_a1.action.precond_pos))
